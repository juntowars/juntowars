...
GamesSchema.statics = {
  ...
  getDoesTileHaveUnits: function (gameName, index) {
    ...
    .then(function (data) {
      ...
      return (tile.infantry + tile.ranged + tile.tanks) > 0;
    });
  },
  ...
  setUnitValue: function (gameName, index, unitType, unitValue, unitRace, callback) {
